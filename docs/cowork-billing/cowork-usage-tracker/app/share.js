window.__CWK_SHARE_DATA__ = {"name":"Cowork Usage Tracker (Retired)","accent":"#4f46e5","accent2":"#3a33ba","isSuite":false,"homeUrl":"https://microsoft.github.io/Analytics-Hub/cowork-billing/","barLabel":"This tool is retired - share the Consumption Dashboard documentation instead","barBtn":"Share the replacement","subject":"Cowork Usage Tracker has been retired - use the Consumption Dashboard in Viva Insights","tagline":"This tool has been retired. Copilot Credit usage over time is now tracked natively by the Consumption Dashboard in Viva Insights &mdash; no manual uploads.","taglineText":"This tool has been retired. Copilot Credit usage over time is now tracked natively by the Consumption Dashboard in Viva Insights - no manual uploads.","glance":"This app existed because Cowork exports were point-in-time snapshots with no history. Microsoft now ships that natively: the Consumption Dashboard in Viva Insights tracks credit usage over time by group, organization or job function, with active users, usage intensity and spending policies nearing their limits.","load":[{"d":"The Consumption Dashboard reads your tenant's data directly. No CSV exports, no checkpoints, no manual uploads.","t":"Nothing to load"}],"source":"<strong>Read the documentation:</strong> <a href='https://learn.microsoft.com/en-us/viva/insights/org-team-insights/ai-cost-dashboard'>How to use the Consumption Dashboard in Insights</a> on Microsoft Learn. Available to Insights Analysts, Managers (scoped to their group) and Global Administrators.","features":["Credit usage trend over time, filterable by group, organization or job function.","Active users, total Copilot Credits consumed and session counts.","Usage intensity across user segments - top 1%, 5%, 6-25% and so on.","Credit usage by spending policy, highlighting policies nearing their limits.","No manual exports: the dashboard reads tenant data directly."],"exports":[{"d":"The supported replacement for this tool. Credit figures there are for reference; the Microsoft 365 admin center remains the billing record of truth.","n":"Consumption Dashboard","tag":"VIVA INSIGHTS"}]};
