window.__CWK_SHARE_DATA__ = {"name": "Cowork Usage Tracker", "accent": "#4f46e5", "accent2": "#3a33ba", "isSuite": false, "homeUrl": "https://microsoft.github.io/Analytics-Hub/cowork-billing/", "barLabel": "Share this tool with a colleague — sends the page you’re on plus the Cowork Billing hub", "barBtn": "Share this tool", "subject": "Cowork Usage Tracker — reconstruct usage trends from point-in-time exports", "tagline": "Copilot Cowork exports are point-in-time snapshots with no history API. Upload exports over time and this tool reconstructs the missing time series &mdash; deltas, trends and a grounded forecast.", "taglineText": "Copilot Cowork exports are point-in-time snapshots with no history API. Upload exports over time and this tool reconstructs the missing time series: deltas, trends and a grounded forecast.", "glance": "Pick which period your export represents, save a checkpoint each time you pull a fresh export, and once you have two or more of the same period type it builds per-user and per-department deltas, run-rate and a pool-exhaustion forecast. Checkpoints live in your browser only.", "load": [{"t": "Copilot credit / Cost Management export &middot; CSV", "d": "Pull it on a cadence (e.g. weekly). Each export you save becomes a checkpoint."}, {"t": "Entra user export(s) &middot; CSV", "d": "Org roll-ups (department, cost center). Rarely changes, so you can reuse one across checkpoints."}], "source": "<strong>Where to get them:</strong> Entra admin center &rarr; Identity &rarr; Users &rarr; All users &rarr; <em>Download users</em>. Microsoft 365 admin center &rarr; Copilot &rarr; Cost management &rarr; Consumption &rarr; <em>Export CSV</em>. Column names are auto-detected, so most export layouts work as-is.", "features": ["Choose the export period (Month-to-Date, Last Month, Year-to-Date) so every calculation is grounded.", "Save a checkpoint per export &mdash; stored in this browser, exportable as a bundle to share.", "Department roll-ups with usage deltas since your first checkpoint.", "Run-rate forecast to period-end and a pool-exhaustion projection.", "Prepaid-pool credit modeling: priority, within-limit or even-split allocation."], "exports": [{"n": "Trends", "tag": "XLSX", "d": "The reconstructed trend and forecast tables in Excel."}, {"n": "Deck", "tag": "PPTX", "d": "A PowerPoint summary of the trends and forecast."}, {"n": "Checkpoint bundle", "tag": "JSON", "d": "Back up or share all your checkpoints; still runs 100% offline on import."}]};
