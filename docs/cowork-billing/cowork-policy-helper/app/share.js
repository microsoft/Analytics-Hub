window.__CWK_SHARE_DATA__ = {"name": "Cowork Policy Helper", "accent": "#6b3fd1", "accent2": "#4c2ba0", "isSuite": false, "homeUrl": "https://microsoft.github.io/Analytics-Hub/cowork-billing/", "barLabel": "Share this tool with a colleague — sends the page you’re on plus the Cowork Billing hub", "barBtn": "Share this tool", "subject": "Cowork Policy Helper — assign users to spend-tier credit policies", "tagline": "Assign users to spend-tier billing policies &mdash; each with a monthly credit allowance &mdash; and forecast how many credits fit current usage.", "taglineText": "Assign users to spend-tier billing policies, each with a monthly credit allowance, and forecast how many credits fit current usage.", "glance": "Every user is placed on a recommended policy from their usage. Move people between tiers, tune each tier&rsquo;s allowance live, watch the impact preview update, and export the assignments. All figures are planning estimates.", "load": [{"t": "Entra user export(s) &middot; CSV", "d": "Department, job title, cost center and business unit. Multiple files allowed."}, {"t": "Copilot credit / Cost Management export &middot; CSV", "d": "Monthly credits used and license status, joined to Entra on UPN."}], "source": "<strong>Where to get them:</strong> Entra admin center &rarr; Identity &rarr; Users &rarr; All users &rarr; <em>Download users</em>. Microsoft 365 admin center &rarr; Copilot &rarr; Cost management &rarr; Consumption &rarr; <em>Export CSV</em>. Column names are auto-detected, so most export layouts work as-is.", "features": ["Every user starts on a recommended policy derived from their usage percentile.", "Move people between tiers and see a live impact preview before you commit.", "Tune each tier&rsquo;s monthly credit allowance &mdash; utilization, fit and cost recompute instantly.", "Auto-adjust everyone to the tier that best fits their actual consumption.", "Forecast next month&rsquo;s budget with an expected-growth rate."], "exports": [{"n": "Assignments", "tag": "CSV", "d": "The full set of user-to-policy assignments."}, {"n": "By policy / By dept / Adjusted", "tag": "CSV", "d": "Roll-ups by tier, by department, and the adjusted allowances after your edits."}, {"n": "Deck &amp; PDF", "tag": "PPTX / PDF", "d": "A PowerPoint summary of the policy plan and a PDF of the current view for sharing."}]};
