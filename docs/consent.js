...
(function () {
  ...
  function injectStyles() {
    ...
    + '.ahc-mhead p{margin:6px 0 0;font-size:13px;color:var(--text-muted,#8585a0)}'
    ...
    + '.ahc-meta{margin-top:8px;font-size:11.5px;color:var(--text-muted,#8585a0);font-family:ui-monospace,Menlo,Consolas,monospace}'
    + '.ahc-req{font-size:11px;font-weight:700;color:var(--text-muted,#8585a0);padding-top:3px}'
