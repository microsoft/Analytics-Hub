...
const RESOURCES = {
  ...
  "credit-usage": [
    ...
    { kind: "download", label: "Interpretation Guide (.pptx)", url: "https://github.com/microsoft/CreditUsage/raw/main/Cowork%20Chargeback%20-%20Report%20Reading%20Guide.pptx" },
  ],
  "ai-solutions": [
  ...
  ess: [
    ...
    { kind: "download", label: "Download .pbit — Dataverse edition", url: "https://github.com/microsoft/ESS/raw/main/ESS%20Dashboard%20-%20Dynamic%20Topics%20(Dataverse)%20V18.pbit" },
    ...
    { kind: "download", label: "Download .pbit (CSV only)", url: "https://github.com/microsoft/AI-in-One-Dashboard/raw/main/AIO%20Dashboard%20-%20Rollup%20Edition%20-%202026-06-25.pbit" },
    { kind: "email",    label: "Admin email template", url: "https://github.com/microsoft/Analytics-Hub/blob/main/docs/email-templates/01_AI_in_One_Dashboard_Admin_Email.txt" },
  ],
  "chat-agent": [
    ...
    { kind: "email",    label: "Admin email template — Chat", url: "https://github.com/microsoft/Analytics-Hub/blob/main/docs/email-templates/02_Chat_Intelligence_Admin_Email.txt" },
    { kind: "email",    label: "Admin email template — Agent", url: "https://github.com/microsoft/Analytics-Hub/blob/main/docs/email-templates/03_Agent_Intelligence_Admin_Email.txt" },
  ],
  "m365-readiness": [
    ...
    { kind: "email",    label: "Admin email template", url: "https://github.com/microsoft/Analytics-Hub/blob/main/docs/email-templates/07_M365_Copilot_Readiness_Admin_Email.txt" },
  ],
  "super-usage": [
  ...
  "super-impact": [
    ...
    { kind: "download", label: "Download .pbit (CSV)", url: "https://github.com/microsoft/superuserimpact/raw/main/Template%20-%20Super%20User%20Impact%20CSV%20-v13.pbit" },
    { kind: "download", label: "Download .pbit (DirectQuery)", url: "https://github.com/microsoft/superuserimpact/raw/main/Template%20-%20Super%20User%20Impact%20Direct%20Query%20-v13.pbit" },
  ],
  "ghcp-impact": [
