...
const NODES = [
  ...
  { id: "ghcp-panel",       kind: "report", label: "GitHub Copilot Panel",     sub: "Depth · delegation · realised value", icon: "🎛️", color: "#00B294", col: 2, isNew: true,
  ...
  { id: "roi-calc",         kind: "addon",  label: "ROI Calculator",           sub: "Shares the Super Usage export", icon: "💰", color: "#e3008c", col: 3,
    topics: ["roi","impact"],
